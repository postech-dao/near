...
class Interact {
    ...
    public root() {
        ...
        this.app.get("/block/:id", (req: express.Request, res: express.Response) => {
        ...
        this.app.get("/account/:id", (req: express.Request, res: express.Response) => {
        ...
        this.app.get("/contract/:id")
        this.app.post("/contract/:id/:method", (req: express.Request, res:express.Response) => {
        ...
        this.app.put("/contract/:id/:method", (req: express.Request, res:express.Response) => {
